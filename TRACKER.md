...
**Last updated:** 2026-07-18 (canonical-host `www`→apex 301s live on BN + KA; TestFlight distribution unblocked via ASC API — beta groups + compliance sweep; DW router fix 1.0(2); BN prod-origin 1.0(2); icon family v4 in design/)
